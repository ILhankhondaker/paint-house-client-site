        ...
        <section style={{
            ...
            <div className='flex-1 p-10'>
                ...
                <h1 className='flex font-bold flex-nowrap'>MY Social Site : <a href="https://www.facebook.com/ilhan.khondaker" class="button" target='blank'><ImFacebook /> </a>
                    ...
                    <a href="https://www.linkedin.com/in/ilhan-khondaker-9a46b01b5/"><BsLinkedin></BsLinkedin></a> <br />
                    (please check my Google info)
                </h1>
                <h1>My Some project : <a className='font-bold' href="https://ass-11-118c8.web.app/?fbclid=IwAR2DeO2P9Wny77M5lJbFY4RMjf1pxauvT25stHyAwclIkglrTcPy_-ixJU8" target='blank'>Ride Car House</a></h1>
            </div>
